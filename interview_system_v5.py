...
speech_logs = []
voice_emotion_logs = []
facial_emotion_logs = []  # New log for facial emotions
...
def main():
    ...
    print("Saved action_log.json, transcription_log.json, voice_emotion_log.json, facial_emotion_log.json, combined_log.json")
